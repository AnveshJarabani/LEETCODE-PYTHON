...
class Solution:
    def isSymmetric(self, root: Optional[TreeNode]) -> bool:
        def sym(left, right):
            ...
            return (
                left.val == right.val
                and sym(left.right, right.left)
                and sym(left.left, right.right)
            )
...
class Solution:
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        def validate(root):
            ...
            balanced = (
                left_bal[0] and right_bal[0] and abs(left_bal[1] - right_bal[1]) < 2
            )
...
print(
    Solution().largestNumber(nums=lst)
)  # -----------------------------------------------
...
# -----------------------------------------------
# leet1
temp = dict(I=1, V=5, X=10, L=50, C=100, D=500, M=1000)
